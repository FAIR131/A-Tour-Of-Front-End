          ...
          <el-steps direction="vertical" :active="3">
            <el-step title="预约">
              <template #description>
                <p class="desc">订单号:<span>{{scope.row.id}}</span></p>
                <p class="desc">车牌号:<span>{{scope.row.carPlate}}</span></p>
                <p class="desc">预检时间:<span>{{scope.row.placeTestTime}}</span></p>
                <p class="desc">地址:<span>{{scope.row.province +
                  scope.row.city +
                  scope.row.area +
                  scope.row.address}}</span></p>
              </template>
            </el-step>
            <el-step title="预检">
              <template #description>
                <p class="desc">客户姓名:<span>{{scope.row.customerName}}</span></p>
                <p class="desc">客户电话:<span>{{scope.row.customerPhone}}</span></p>
                <p class="desc">代检司机:<span>{{scope.row.driverName}}</span></p>
