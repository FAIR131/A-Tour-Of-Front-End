          ...
          <el-steps direction="vertical" :active="3">
            ...
            <el-step title="预检">
              <template #description>
                ...
                <p class="desc">
                  取车签字:
                  <el-image style="width: 100px" :src="orderService.pickCarCustomerSign" :preview-src-list="[orderService.pickCarCustomerSign]"></el-image>
                  <el-image style="width: 100px" :src="orderService.pickCarDriverSign" :preview-src-list="[orderService.pickCarDriverSign]"></el-image>
                </p>
              </template>
            </el-step>
