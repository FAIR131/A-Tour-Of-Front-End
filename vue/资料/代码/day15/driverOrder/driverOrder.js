export default {
    ...
    cancelOrder:function(id){
        this.$http.delete("/order/deleteDriverOrder",{params:{id}}).then(res=>{
            if(res.data.code){
    ...
    // changeDay:function(){
        // this.day++;
        // vue中数据更新时,页面不会立马更新,而是等待所有数据更新后,统一更新页面
        // console.log(this.$refs.myPNode.innerHTML)
        // vue页面每次更新之后都会触发$nextTick回调
        // this.$nextTick(()=>{
        //     console.log(this.$refs.myPNode.innerHTML)
        // })
    // }
