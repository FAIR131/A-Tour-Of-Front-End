	...
	<view class="content">
		...
		<view class="login-form">
			<view class="item phone">
				...
				<input v-model="user.account" class="uni-input" placeholder="手机号" placeholder-class="input-placeholder" />
			</view>
			<view class="item password">
				<image class="icon left" src="/static/mine/lock.png" mode="widthFix"></image>
				<input v-model="user.password" class="uni-input" type="password" placeholder="密码" placeholder-class="input-placeholder" />
			</view>
	...
	export default {
		data() {
			return {
				...
				loginRules:[
				  {name: 'account', type: 'required', errmsg: '请输入账号'},
				  {name: 'account', required: true, type: 'phone', errmsg: '请输入正确的手机号'},
