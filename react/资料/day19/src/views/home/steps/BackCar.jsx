    ...
    return (
        <>
            <Card title="交界车确认">
                ...
                <p>委托人签字</p>
                {props.currentOrder.orderState === '订单完成' && <Image src={props.currentServiceOrder.backCarCustomerSign}></Image>}
                {props.currentOrder.orderState === '正在进行' && <Sign type={3} orderId={props.currentOrder.id}></Sign>}

                <p>受托人签字</p>
                {props.currentOrder.orderState === '订单完成' && <Image src={props.currentServiceOrder.backCarDriverSign}></Image>}
