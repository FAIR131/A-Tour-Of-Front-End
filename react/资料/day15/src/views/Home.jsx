...
import CoachSubmitted from './coach/CoachSubmitted';
import CoachExamin from './coach/CoachExamin';
        ...
        <Layout>
            ...
            <Content>
                <Switch>
                    ...
                    <Route path={`${match.path}/coach-submitted`} component={CoachSubmitted}></Route>
                    <Route path={`${match.path}/coach-examine`} component={CoachExamin}></Route>
                </Switch>
            </Content>
        </Layout>
    );
