                ...
                props.orders.map(item => {
                    ...
                    return (
                        <li key={item.id} onClick={async ()=>{
                            let res=await http.get("/driverOrder/findDriverServiceById", { params: { id: props.currentOrder.id } })
...
export default connect(
    ...
    (dispatch) => {
        return {
            ...
            init_current_service_order: (serviceOrder) => {
                dispatch({ type: "INIT_CURRENT_SERVICE_ORDER", serviceOrder })
            }
        }
    }
)(OrderList);